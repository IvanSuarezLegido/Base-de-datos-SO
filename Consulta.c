...
int main() {
    ...
    char query[MAX];
    snprintf(query, MAX, "SELECT COUNT(*) AS veces_caida_en_muerte FROM CasillaMuerte JOIN Jugador ON CasillaMuerte.jugador_id = Jugador.ID WHERE Jugador.username = '%s';", username);
    ...
    printf("Número de veces que %s ha caído en la casilla de muerte: ", username);
